    ...
    <div className="h-screen w-screen flex justify-center items-center bg-slate-200">
      <form className="bg-white px-20 py-20 rounded-md flex flex-col gap-1 w-[500px]" onSubmit={handleSubmit}>
        ...
        <>
          ...
          <input type="text" name="name" onChange={handleChange} value={formData.name} className="px-2 py-2 border-2 border-gray-200 rounded-md mb-2"/>
        </>
        }
        ...
        <input type="email" name="email" onChange={handleChange} value={formData.email} className="px-2 py-2 border-2 border-gray-200 rounded-md mb-2"/>
        <label htmlFor="password">Password</label>
        <input type="text" name="password" onChange={handleChange} value={formData.password} className="px-2 py-2 border-2 border-gray-200 rounded-md"/>
        {invalidLogin && (
